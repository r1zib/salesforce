...
====What's new on PHPdocX 2.4?====
PRO VERSION
- Bug fixes
- New examples
- Variable replacement in multiple headers and footers
- Insertion of MHT files
- Insertion of MHT files to add offline images in templates
- New graphics radar-like
- Basic convertor from XHTML to WordML
- Escaped XHTML to avoid errors when insert in templates
- Please, check this URL about the use of AltChunk and the available versions of Office an Open Office: http://www.phpdocx.com/archives/1978
